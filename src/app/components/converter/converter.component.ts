...
import {ExchangeRatesResponse, MappedCurrencyRateObject} from '../../model/exchange-rates.model';
...
export class ConverterComponent implements OnInit {
  ...
  constructor(
    public currencyExchangeService: ExchangeCurrencyService,
